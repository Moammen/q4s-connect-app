...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1322: (x0,x1,x2,x3,x4,x5,x6,x7) => x0.unwrapKey(x1,x2,x3,x4,x5,x6,x7),
      _1323: (x0,x1,x2,x3,x4,x5) => x0.importKey(x1,x2,x3,x4,x5),
      _1324: (x0,x1,x2,x3) => x0.generateKey(x1,x2,x3),
      _1325: (x0,x1,x2,x3,x4) => x0.wrapKey(x1,x2,x3,x4),
      _1326: (x0,x1,x2) => x0.exportKey(x1,x2),
      _1327: (x0,x1,x2) => x0.setItem(x1,x2),
      _1328: (x0,x1) => x0.getRandomValues(x1),
      _1329: (x0,x1,x2,x3) => x0.encrypt(x1,x2,x3),
      _1330: (x0,x1,x2,x3) => x0.decrypt(x1,x2,x3),
      _1331: Date.now,
      ...
      _1462: (x0,x1,x2) => x0.open(x1,x2),
      _1463: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      _1464: x0 => x0.abort(),
      _1465: (x0,x1) => x0.send(x1),
      _1466: x0 => x0.send(),
      _1467: x0 => x0.getAllResponseHeaders(),
      _1468: () => new AbortController(),
      _1469: x0 => x0.abort(),
      _1470: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1471: (x0,x1) => globalThis.fetch(x0,x1),
      _1472: (x0,x1) => x0.get(x1),
      _1473: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1473(f,arguments.length,x0,x1,x2) }),
      _1474: (x0,x1) => x0.forEach(x1),
      _1475: x0 => x0.getReader(),
      _1476: x0 => x0.cancel(),
      _1477: x0 => x0.read(),
      ...
      _1487: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      _1488: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      _1513: (s, m) => {
        try {
      ...
      _1529: o => o.length,
      _1531: (o, i) => o[i],
      _1532: f => f.dartFunction,
      _1533: () => ({}),
      _1534: () => [],
      _1536: () => globalThis,
      _1537: (constructor, args) => {
      ...
      _1539: (o, p) => o[p],
      _1540: (o, p, v) => o[p] = v,
      _1541: (o, m, a) => o[m].apply(o, a),
      _1543: o => String(o),
      _1544: (p, s, f) => p.then(s, (e) => f(e, e === undefined)),
      _1545: o => {
      ...
      _1670: x0 => x0.readyState,
      _1672: (x0,x1) => { x0.timeout = x1 },
      _1674: (x0,x1) => { x0.withCredentials = x1 },
      _1675: x0 => x0.upload,
      _1676: x0 => x0.responseURL,
      _1677: x0 => x0.status,
      _1678: x0 => x0.statusText,
      _1680: (x0,x1) => { x0.responseType = x1 },
      _1681: x0 => x0.response,
      _1693: x0 => x0.loaded,
      _1694: x0 => x0.total,
      _3463: () => globalThis.window,
      _3781: x0 => x0.isSecureContext,
      _3784: x0 => x0.crypto,
      _3789: x0 => x0.sessionStorage,
      _3790: x0 => x0.localStorage,
      _6068: x0 => x0.signal,
      _6140: () => globalThis.document,
      _6556: (x0,x1) => { x0.id = x1 },
      _6583: x0 => x0.children,
      _7902: x0 => x0.value,
      _7904: x0 => x0.done,
      _8600: x0 => x0.url,
      _8602: x0 => x0.status,
