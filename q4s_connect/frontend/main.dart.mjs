...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1284: (x0,x1) => x0.removeItem(x1),
      _1286: (x0,x1) => x0.getItem(x1),
      _1287: (x0,x1,x2,x3,x4,x5,x6,x7) => x0.unwrapKey(x1,x2,x3,x4,x5,x6,x7),
      _1288: (x0,x1,x2,x3,x4,x5) => x0.importKey(x1,x2,x3,x4,x5),
      _1289: (x0,x1,x2,x3) => x0.generateKey(x1,x2,x3),
      _1290: (x0,x1,x2,x3,x4) => x0.wrapKey(x1,x2,x3,x4),
      _1291: (x0,x1,x2) => x0.exportKey(x1,x2),
      _1292: (x0,x1,x2) => x0.setItem(x1,x2),
      _1293: (x0,x1) => x0.getRandomValues(x1),
      _1294: (x0,x1,x2,x3) => x0.encrypt(x1,x2,x3),
      _1295: (x0,x1,x2,x3) => x0.decrypt(x1,x2,x3),
      _1296: Date.now,
      ...
      _1374: (t, s) => t.set(s),
      _1375: l => new DataView(new ArrayBuffer(l)),
      _1376: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1377: o => o.byteLength,
      _1378: o => o.buffer,
      ...
      _1437: (x0,x1,x2) => x0.open(x1,x2),
      _1438: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      _1439: x0 => x0.abort(),
      _1440: (x0,x1) => x0.send(x1),
      _1441: x0 => x0.send(),
      _1442: x0 => x0.getAllResponseHeaders(),
      ...
      _1457: x0 => ({type: x0}),
      _1458: (x0,x1) => new Blob(x0,x1),
      _1459: x0 => globalThis.URL.createObjectURL(x0),
      _1460: (x0,x1) => x0.appendChild(x1),
      _1461: x0 => x0.click(),
      _1462: x0 => x0.remove(),
      _1463: x0 => globalThis.URL.revokeObjectURL(x0),
      _1472: (s, m) => {
        try {
      ...
      _1648: x0 => x0.loaded,
      _1649: x0 => x0.total,
      _2071: (x0,x1) => { x0.download = x1 },
      _2096: (x0,x1) => { x0.href = x1 },
      _3418: () => globalThis.window,
      _3736: x0 => x0.isSecureContext,
      _3739: x0 => x0.crypto,
      _3744: x0 => x0.sessionStorage,
